...
public class Reader extends JFrame {
    ...
    File file = new File("Product revenue.txt");
    ...
    static String[] box3 = {"2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021"};
    ...
    public Reader(String str) {
        ...
        l1 = new JLabel("Назовите продуктовый предмет");
        l2 = new JLabel("Состав");
        l3 = new JLabel("Дата производства");
        l4 = new JLabel("В холодильник суём?");
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                try {
                    ...
                    out.write(text1 + " - ");
                    out.write(area2 + "\n");
                    if (k == 1) out.write("Хранить в холодильной камере. " + "\n");
                    else if (k == -1) out.write("Хранить при комнотной температуре. " + "\n");
                    out.write("Дата производства:" + boxA + " " + boxB + " " +
